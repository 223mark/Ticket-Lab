    ...
    <div class="border rounded-lg shadow-lg bg-white pb-6">
        ...
        <div class="flex flex-col px-4 py-2 space-y-4 ">
            ...
            <div class="flex">
                ...
                <div class="w-1/2 ">
                    <p class=" fw-semibold">{{ store.state.selectedDate }} </p>
                </div>
            </div>
            <div class="flex">
                <div class="w-1/2  ">
        ...
        <div class="mt-5 flex justify-center items-center">
            ...
            <router-link :to="{ name: 'app.checkout', params: { ticketId: selectedTicket.ticketId } }" v-if="!ticketDetail">
