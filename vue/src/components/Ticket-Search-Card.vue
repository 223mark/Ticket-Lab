<template>
<div class="flex flex-col space-y-4 px-4 py-4 mx-auto bg-white  shadow-lg rounded-lg w-4/5  ">
    <div class="w-full space-y-4">
     ...
     <div class="space-y-4">
        ...
        <div class="w-full space-y-4 ">
            ...
            <Datepicker v-model="selectedDate" position="center" id="date" :format="format" :min-date="minDate" :max-date="maxDate"></Datepicker>
        </div>
