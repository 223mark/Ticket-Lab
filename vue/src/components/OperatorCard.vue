<template>
        ...
        <div class="w-1/4" v-for="operator in operators" :key="operator.id">
            <div
                ...
                <div class="p-5">
                    ...
                    <router-link :to="{ name: 'app.operators.detail', params: { operator: operator.id } }"
                        class="text-white mt-4 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Read more
