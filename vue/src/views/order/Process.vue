<template>
    <div class=" ml-6 mt-20" @click="$router.back()">
            ...
            <div class="flex justify-between pt-2 md:pt-4 gap-1">
                <div 
                    class="flex justify-between  gap-2 flex-wrap ml-2 w-full mx-2 ">
                        <div class="flex justify-center items-center bg-gray-400 w-1/3 md:w-1/5 h-12 cursor-pointer"  v-for="t in tickets" :key="t.id" @click="chooseSeat(t)">
